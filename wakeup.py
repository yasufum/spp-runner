...
windows = [
...

   {
    ...
    "opts": "%s %s %s" % (spp_srcdir, ctrl_host, ctrl_pri_port),
    "enter": True
    },

   {
    ...
    "opts": "%s %s %s %s %s" % (spp_srcdir, secondaries[0].get("id"), secondaries[0].get("coremask"), ctrl_host, ctrl_sec_port),
    "enter": True
    },

   {
    ...
    "dir": run_dir,
    "cmd": "sh runscripts/secondary.sh",
    "opts": "%s %s %s %s %s" % (spp_srcdir, secondaries[1].get("id"), secondaries[1].get("coremask"), ctrl_host, ctrl_sec_port),
    "enter": True
    },
